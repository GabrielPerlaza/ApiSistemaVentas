    ...
    public partial class DbVentasContext2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__8A3D240CBF63FE93", x => x.idCategoria);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Menu__C26AF48367BFE3D1", x => x.idMenu);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__NumeroDo__471E421A7C94407B", x => x.idNumeroDocumento);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Rol__3C872F763B23EB3F", x => x.idRol);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Venta__077D56145F16712C", x => x.idVenta);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Producto__07F4A132FB907B33", x => x.idProducto);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MenuRol__9D6D61A422A70BD7", x => x.idMenuRol);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Usuario__645723A6AA40804C", x => x.idUsuario);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__DetalleV__BFE2843FD916817A", x => x.idDetalleVenta);
                    table.ForeignKey(
